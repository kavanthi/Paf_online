...
<div class="main">
                    ...
                    <form style="text-align:center" action="addbook" method="post">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Product No</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="productno" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
                      
                          <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >product Name</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="title" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
                          
                             <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Number of products</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="copyno" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
								
							<div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Product price:</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="price" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
								<div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Description</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter ISBM No" id="input2" name="description" pattern="[A-Za-z0-9]{1,5}" title="Field can't be empty">
                        </div>
						
								
							
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton">Add Product</button>
                              </form>
                            </td>
                            </tr>
                            </table>
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf"></p>
      <p class="rf">PAF Group project </p>
	  <p class="rf">2019/ </p>
      <div class="clr"></div>
    </div>
  </div>
