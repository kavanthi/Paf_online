    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>SellNBye</h2>
          <div class="clr"></div>
          <img src="resources/images/img1.jpg" width="613" height="154" alt="" />
          <p></p>
        </div>
        <div class="article">
          <h2><span>User friendly environment </span> </h2>
          <div class="clr"></div>
          <img src="resources/images/img2.jpg" width="613" height="154" alt="" />
			<p> </p>
			<p> </p>
			<p> </p>
        </div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="login.jsp">Product</a></li>
